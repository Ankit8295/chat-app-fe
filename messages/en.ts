const messages = {
  ...
  "aria-message-list": "Messages",
  "aria-loading-messages": "Loading messages",
  "label-no-messages": "No messages yet",
  "label-no-messages-hint": "Send a message to start the conversation.",
  "label-loading-older-messages": "Loading older messages...",
  "error-send-not-connected": "Not connected. Try again in a moment.",
